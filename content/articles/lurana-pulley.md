...
## Oral History of Lurana Pulley {#oral_history_of_lurana_pulley}

### The Road to Grant County and Marriage {#the_road_to_grant_county_and_marriage}
...
### Daily Life: \"We just bought what we could buy and lived with it and got by.\" {#daily_life_we_just_bought_what_we_could_buy_and_lived_with_it_and_got_by.}

#### During World War II {#during_world_war_ii}
...
#### During the Depression {#during_the_depression}
...
#### With Addition of Factories {#with_addition_of_factories}
...
#### Without Electricity (Oil Lamps & Ice Boxes) {#without_electricity_oil_lamps_ice_boxes}
...
### Marital Contentment: \"We was both there together.\" {#marital_contentment_we_was_both_there_together.}
...
#### Visiting (If Not Exhausted) {#visiting_if_not_exhausted}
...
### Farming Methods: \"Farm work was awfully hard.\" {#farming_methods_farm_work_was_awfully_hard.}

#### Working the Ground {#working_the_ground}
...
#### Easing the Work with a Radio and Electricity {#easing_the_work_with_a_radio_and_electricity}
...
##### Electric Stove vs. Oil Stove {#electric_stove_vs._oil_stove}
...
##### Radio vs. Newspaper {#radio_vs._newspaper}
...
#### Loading Hay without a Tractor {#loading_hay_without_a_tractor}
...
#### Feeding the Thrashers {#feeding_the_thrashers}
...
#### Currying the Horses {#currying_the_horses}
...
#### Driving a Truck and Driving a Horse and Buggy {#driving_a_truck_and_driving_a_horse_and_buggy}
