...
## Oral History of Pauline Marler {#oral_history_of_pauline_marler}
...
### Entertainment: Movies, Bicycling, and Matter Park {#entertainment_movies_bicycling_and_matter_park}
...
### Marion High School\'s Easter Parade {#marion_high_schools_easter_parade}
...
### Halloween Tricks {#halloween_tricks}
...
### Racial Attitudes and 1930 Lynching {#racial_attitudes_and_1930_lynching}
...
#### Women\'s Contribution {#womens_contribution}
...
#### Working at Anaconda {#working_at_anaconda}
...
#### Emotional Impact of the War and the Atomic Bomb {#emotional_impact_of_the_war_and_the_atomic_bomb}
...
#### Impact of War on the Medical Field {#impact_of_war_on_the_medical_field}
...
#### Migrants and POWs at Snyder Ketchup Plant {#migrants_and_pows_at_snyder_ketchup_plant}
...
#### First Use of Penicillin at Marion General Hospital {#first_use_of_penicillin_at_marion_general_hospital}
...
#### Transportation and the Black Market {#transportation_and_the_black_market}
...
#### Back to Normal with Thankful Hearts {#back_to_normal_with_thankful_hearts}
