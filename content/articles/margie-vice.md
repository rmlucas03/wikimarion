...
## Oral HIstory of Margie Vice {#oral_history_of_margie_vice}

### Early Married Life {#early_married_life}
...
#### Life on a Shoestring Budget {#life_on_a_shoestring_budget}
...
#### Birth of Children {#birth_of_children}
...
#### Traveling: Cars, Trucks, and Trains {#traveling_cars_trucks_and_trains}
...
#### One Income Family But . . . {#one_income_family_but_._._.}
...
##### Lawn Improvement {#lawn_improvement}
...
##### Care of Seven Boys (Margie\'s Two Plus) {#care_of_seven_boys_margies_two_plus}
...
#### Money Allotment {#money_allotment}
...
#### Support of Parents {#support_of_parents}
...
#### Canning & Ironing with Friends {#canning_ironing_with_friends}
...
##### The Telegram: Good News {#the_telegram_good_news}
...
##### Sister\'s Husband: Shot Down and Killed Overseas {#sisters_husband_shot_down_and_killed_overseas}
...
##### Battling Loneliness {#battling_loneliness}
...
#### Memories of the Lynching {#memories_of_the_lynching}
...
#### Common Terminology {#common_terminology}
...
#### Louisiana: Shoe Stores, Drinking Fountains, and Work {#louisiana_shoe_stores_drinking_fountains_and_work}
...
#### Reunions, Hiking, Birthdays {#reunions_hiking_birthdays}
...
#### First Night Out Alone {#first_night_out_alone}
...
### Transportation: Streetcars and Bicycles and Feet {#transportation_streetcars_and_bicycles_and_feet}
...
#### Buying on Credit {#buying_on_credit}
...
#### Borrowing to Make Ends Meet {#borrowing_to_make_ends_meet}
...
#### Receiving Help from the Grocer {#receiving_help_from_the_grocer}
...
### Saga of Canadian Shopping Trip {#saga_of_canadian_shopping_trip}

#### Buying Shoes {#buying_shoes}
...
#### Delayed at the Border {#delayed_at_the_border}
...
#### Waiting for Their Return {#waiting_for_their_return}
